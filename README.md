...
1. Explain what a token is used for.
   A token is used to authorize a certain user from accessing or manipulating data.

2. What steps can you take in your web apps to keep your data secure?
   Keep data in protected routes which can only be accessed with a token from a successful login.

3. Describe how web servers work.
   A web server responds to user requests and provides the code necessary for a website to display. It is physically where hardware and code is stored.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
   The Create in CRUD is a post.
   The Request in CRUD is a get.
   The Update in CRUD is a put.
   The Delete in CRUD is a delete.
